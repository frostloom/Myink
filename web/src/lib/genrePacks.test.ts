...
test('compose keeps primary rules and marks the 7:3 secondary', () => {
  ...
  expect(fields.selling_point).toContain('7:3')
  expect(fields.mechanics).toEqual(['修仙机制'])
  expect(fields.taboos).toEqual(['修仙禁忌'])
  expect(fields.satisfaction).toEqual(['修仙爽点'])
})
