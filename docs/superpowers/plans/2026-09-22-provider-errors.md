...
- 任务 1：`9aa3262`，相关测试 65 项通过，Python 全量 959 passed / 5 xfailed；[CI 三项成功](https://github.com/frostloom/Myink/actions/runs/35741711007)。
- 任务 2：`8a827eb`，相关测试 28 项通过，Python 全量 965 passed / 5 xfailed；[CI 三项成功](https://github.com/frostloom/Myink/actions/runs/35743467331)。
...
- [x] 路径核对：基于 `a3b1c7d` 当前代码结构；旧 Go 目录与旧计划行号不是修改依据。
