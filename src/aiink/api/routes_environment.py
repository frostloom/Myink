...
from aiink.api.auth import require_user
from aiink.api.routes_settings import (
    ConnectionProbeBody,
    ModelConnectionBody,
...
from aiink.api.schemas import ConnectionTestOut, EnvironmentOut, ModelListOut, RankingsProbeOut
from aiink.config import settings
from aiink.environment import load_environment, load_raw, save_raw
...
def _validate_rankings(body: RankingsBody, existing: dict) -> dict:
    from aiink.environment import merge_rankings
