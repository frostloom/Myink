...
from aiink.providers.connections import CUSTOM_ROUTE_PREFIX, price_table, unpack_model_settings
...
from aiink.providers.prices import DEEPSEEK_PRICES
...
def _thinking_enabled(project_id, db) -> bool:
    from aiink.environment import thinking_enabled_for_user
